...
Toute la mémoire du projet vit dans `docs/`. Chaque avancée est tracée et mise à jour en continu.

- [`docs/01-vision.md`](docs/01-vision.md) — Pourquoi Symbiose, constat, ambition.
